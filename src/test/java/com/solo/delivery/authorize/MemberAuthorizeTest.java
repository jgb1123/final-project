...
@MockBean({JpaMetamodelMappingContext.class, MemberService.class, JwtTokenizer.class, CustomAuthorityUtils.class, MemberMapper.class, GlobalExceptionAdvice.class})
