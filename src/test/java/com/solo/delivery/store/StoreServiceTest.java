...
public class StoreServiceTest {
    ...
    void searchStoreTest() {
        ...
        store1.changeStoreCategory(storeCategory);
        store2.changeStoreCategory(storeCategory);
        given(storeRepository.searchStore(Mockito.anyString(), Mockito.anyInt(), Mockito.anyInt(), Mockito.any(Pageable.class)))
        ...
        Page<StoreResponseDto> storePage = storeService.searchStore("김치볶음밥", 20000, 3000, PageRequest.of(1, 10, Sort.by("totalOrderCnt").descending()));
